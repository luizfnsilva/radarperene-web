...
const EN_BODY = (function () {
  const C = {
    ...
    ladder: [{ t: "Briefing", d: "the essentials in 5 seconds" }, { t: "Lens", d: "stress by domain" }, { t: "Scenarios", d: "trajectories and windows" }, { t: "War Room", d: "proof and propagation" }, { t: "Modeling", d: "cross everything · 50+ yrs · historical analogs" }],
...
function _renderDiarioDia(snap, date, origin, lang, nav) {
  ...
  const _pulseVis = [_pP != null ? (en ? "Perene Risk Index " : "Índice de Risco Perene ") + _pP + "/100" : null,
    _pA != null ? (en ? "Ânima Index " : "Índice Ânima ") + _pA + "/100" : null].filter(Boolean).join(" · ");
  const desc = _esc((en
  ...
  // ★ pulso HERÓI: nome cheio do índice + "como interpretar?" discreto (retirada GRADUAL da legenda — o novo visitante
  //   não fica perdido, mas a tradução não compete com o nome). Link → guia de leitura (a explicação mora fora do Diário).
  const mancheteHtml = _pulseVis ? "<p class=\"manch\">" + (en ? "Today’s pulse — " : "O pulso do dia — ") + "<b>" + _esc(_pulseVis) + "</b><a class=\"manch-help\" href=\"" + (en ? "/how-to-read-the-radar/" : "/como-ler-o-radar/") + "\">" + (en ? "how to read?" : "como interpretar?") + "</a></p>" : "";
