...
const EN_BODY = (function () {
  ...
  return {
    ...
    "sem-eyb": "Subscription", "sem-h": "Perene Semanal", "sem-s": "Every Friday, a read of the Brazilian market — regime, intermarket, the external backdrop, sentiment and the comparable episodes. US$ 29/mo.", "sem-cta": "Subscribe to Perene Semanal →",
...
const EN_GRAPH = JSON.stringify({
  "@context": "https://schema.org", "@graph": [
    ...
    { "@type": "Service", "@id": "https://radarperene.com/#service", "name": "Radar Perene — Perene Semanal", "serviceType": "Editorial publication on the Brazilian market regime", "provider": { "@id": "https://radarperene.com/#org" }, "areaServed": { "@type": "Country", "name": "Brazil" }, "description": "Perene Semanal: the weekly edition on the Brazilian market regime (every Friday) — regime, intermarket, the external backdrop, sentiment and the comparable episodes — plus the archive of editions and access to each day's open edition. Descriptive, never a recommendation.", "offers": { "@type": "Offer", "price": "29", "priceCurrency": "USD", "url": "https://radarperene.com/subscribe" }, "hasOfferCatalog": { "@type": "OfferCatalog", "name": "Cadence", "itemListElement": [{ "@type": "OfferCatalog", "name": "Weekly (Friday) + archive + daily open edition" }] } }
  ]
});
