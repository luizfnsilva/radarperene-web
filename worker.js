...
const EN_FAQ = JSON.stringify({
  "@context": "https://schema.org", "@type": "FAQPage", "inLanguage": "en", "mainEntity": [
    { "@type": "Question", "name": "When does the weekly edition arrive?", "acceptedAnswer": { "@type": "Answer", "text": "The weekly edition arrives on Friday, after the market close (around 8:30pm BRT). The free daily reading goes out ~50 minutes before the open, with the prior day's close, and the summary is posted to X/LinkedIn right after. The monthly closes on the last day of the month." } },
    { "@type": "Question", "name": "Are the weekly editions archived?", "acceptedAnswer": { "@type": "Answer", "text": "Yes — each Friday edition stays in your subscriber account. Perene Semanal is one edition per week; it does not include the monthly report library or the per-asset observatory, which are part of institutional access." } },
...
function _renderDiarioDia(snap, date, origin, lang, nav) {
  ...
  const _pItems = _pItem(en ? "Perene Risk Index" : "Índice de Risco Perene", _pP) + _pItem(en ? "Ânima Index" : "Índice Ânima", _pA);
