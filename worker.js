...
const EN_BODY = (function () {
  const C = {
    ...
    cta1: "Subscribe to Perene Semanal →", cta2: "Read today&rsquo;s edition →", micro: "Educational content from public sources — never a recommendation.",
    ...
    fbadge: "Institutional access", fed: "Institutional access", fprice: '<b style="color:var(--gold-ink)">By invitation</b>', fh: "Access to the complete archive.", fp: '<ul style="list-style:none;padding:0;margin:14px auto 0;display:table;text-align:left;font-size:14px;line-height:1.95"><li><span style="color:var(--gold-ink)">✓</span> the entire report library since April 2010</li><li><span style="color:var(--gold-ink)">✓</span> the full outcomes of every similar episode</li><li><span style="color:var(--gold-ink)">✓</span> the provenance of every reading</li><li><span style="color:var(--gold-ink)">✓</span> the historical distribution at 3, 6 and 12 months</li><li><span style="color:var(--gold-ink)">✓</span> daily, weekly and monthly reports by email</li><li><span style="color:var(--gold-ink)">✓</span> a living archive that grows every day</li></ul><div style="margin-top:12px;font-size:13px;opacity:.75">Locked while your subscription stays active · 7-day refund · cancel in one click</div>',
    fdisc: "",
    wlbtn: "Get my invite",
    ...
    ftnav: '<span class="ftcol"><b>Reading</b> <a href="/daily">Daily</a> · <a href="/articles">Articles</a> · <a href="/free/">Free</a> · <a href="/ativos">Assets</a></span><span class="ftcol"><b>The Radar</b> <a href="/how-to-read-the-radar/">How to read</a> · <a href="/methodology/">Methodology</a> · <a href="/concepts/">Concepts</a></span><span class="ftcol"><b>For institutions</b> <a href="/founder/">Institutional access</a> · <a href="/lenses/">Lenses</a> · <a href="/api/docs/">API</a> · <a href="/widgets/">Widgets</a></span><span class="ftcol"><b>House &amp; legal</b> <a href="/about">About</a> · <a href="/terms/">Terms</a> · <a href="/privacy/">Privacy</a></span>',
    ...
    eyb8: "Free × institutional", s8: "What institutional access opens", s8s: "Free shows <b>where we are</b> — today&rsquo;s regime, lenses, mood and valuation. Institutional access answers <b>what historically happened next</b>: the full distribution of analogous cases (probability of rising, median and range over 3/6/12 months) + the quantile cone, a working chart and all 6 Lenses (with Vértice) — plus the daily, weekly and monthly reports and the library since 2010.",
  ...
  const topnav = '<a href="/articles">Articles</a><a href="' + U_CON + '">' + NAV.con + '</a><a href="/daily">' + NAV.dia + '</a><a href="/founder/">Institutional</a>';
  ...
  return {
    ...
    "cta3": "Institutional access →", "cta-deep": "For readers who want to see what underpins the Radar&rsquo;s readings.",
    "fnd-lead": "The mechanisms behind the readings.", "fnd-s": "To see what underpins the readings: the precedents, the historical analogs and the Radar&rsquo;s proprietary observatory.", "fnd-cta": "Institutional access →",
    "sem-eyb": "Subscription", "sem-h": "Perene Semanal", "sem-s": "Every Friday, a read of the Brazilian market — valuation, intermarket, the external backdrop, sentiment and the comparable episodes. US$ 29/mo.", "sem-cta": "Subscribe to Perene Semanal →",
...
const EN_GRAPH = JSON.stringify({
  "@context": "https://schema.org", "@graph": [
    ...
    { "@type": "Dataset", "@id": "https://radarperene.com/#dataset", "name": "Radar Perene — Brazil market regime, macro and intermarket", "description": "Descriptive series and scores of the market regime, rates/Selic, country risk, intermarket, FX, REITs (IFIX), Treasury, crypto, the equity risk premium (earnings yield vs real rate), real estate (ILI · Real Estate Liquidity Index) and inflation (IPCA/IGP-M/INCC/SINAPI), plus regulatory/judicial activity. Public data since 2000, continuously updated. Descriptive, never a recommendation or price forecast.", "url": "https://radarperene.com/", "creator": { "@id": "https://radarperene.com/#org" }, "isAccessibleForFree": true, "license": "https://radarperene.com/", "inLanguage": ["en", "pt-BR"], "spatialCoverage": { "@type": "Place", "name": "Brazil" }, "temporalCoverage": "2000-01-01/..", "keywords": ["market regime", "country risk", "Brazil macro", "interest rates", "Selic", "intermarket", "FX", "equity risk premium", "fair value", "IFIX", "REITs", "IBOV", "Brazilian Treasury", "Brazil valuation", "real estate liquidity", "ILI", "inflation", "IPCA", "study library", "historical analogs", "asset comparisons", "self-evaluation", "historical distributions", "market precedents", "conditional events", "what happened next"], "variableMeasured": ["regime_br_score", "risk_global_score", "equity risk premium", "fair value", "intermarket", "analog-case distribution (3/6/12m)", "median and p10-p90 bands"], "distribution": { "@type": "DataDownload", "encodingFormat": "application/json", "contentUrl": "https://radarperene.com/INTEGRACAO_RADAR.md" } },
    { "@type": "Service", "@id": "https://radarperene.com/#service", "name": "Radar Perene — Perene Semanal", "serviceType": "Editorial publication on the Brazilian market regime", "provider": { "@id": "https://radarperene.com/#org" }, "areaServed": { "@type": "Country", "name": "Brazil" }, "description": "Perene Semanal: the weekly edition on the Brazilian market regime (every Friday) — valuation, intermarket, the external backdrop, sentiment and the comparable episodes — plus the archive of editions and access to each day's open edition. Descriptive, never a recommendation.", "offers": { "@type": "Offer", "price": "29", "priceCurrency": "USD", "url": "https://radarperene.com/subscribe" }, "hasOfferCatalog": { "@type": "OfferCatalog", "name": "Cadence", "itemListElement": [{ "@type": "OfferCatalog", "name": "Weekly (Friday) + archive + daily open edition" }] } }
  ]
});
...
function _memoGate(date, hasWeekly) {
  ...
  return '<div id="rp-weekly" class="wsamplebox" style="display:none"></div>' +
    ...
    'function gancho(){box.innerHTML=\'<div class="memogate"><div class="gh">\'+(EN?"The full reading is for subscribers":"A leitura completa \\u00e9 para assinantes")+\'</div><p>\'+(EN?"Daily, weekly and monthly reports \\u2014 subscribers only.":"Relat\\u00f3rios di\\u00e1rios, semanais e mensais \\u2014 exclusivos para assinantes.")+\'</p><div class="ghb"><a class="btn2" href="\'+(EN?"/subscribe":"/assine")+\'">\'+(EN?"See subscriptions":"Ver assinaturas")+\'</a> <a href="#" id="rp-login" class="lg">\'+(EN?"Already a subscriber? Sign in":"J\\u00e1 \\u00e9 assinante? Entrar")+\'</a></div></div>\';var lg=document.getElementById("rp-login");if(lg)lg.onclick=function(e){e.preventDefault();sb.auth.signInWithOAuth({provider:"google",options:{redirectTo:location.href}});};}' +
...
function _renderDiarioDia(snap, date, origin, lang, nav) {
  ...
  const vozHtml = narr.texto_html ? "<div class=\"voz\">" + narr.texto_html + "</div>" : "";
...
async function _route(request, env, ctx) {
    ...
    if (_url.pathname === "/ativos") {
      ...
      const html = "<!doctype html><html lang=\"" + (en ? "en" : "pt-BR") + "\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><link rel=\"icon\" href=\"/favicon.ico\" sizes=\"48x48\"><link rel=\"icon\" type=\"image/png\" sizes=\"32x32\" href=\"/favicon-32x32.png\"><link rel=\"icon\" type=\"image/png\" sizes=\"16x16\" href=\"/favicon-16x16.png\"><link rel=\"icon\" type=\"image/svg+xml\" href=\"/icon-light.svg\" media=\"(prefers-color-scheme: light)\"><link rel=\"icon\" type=\"image/svg+xml\" href=\"/icon-dark.svg\" media=\"(prefers-color-scheme: dark)\"><link rel=\"apple-touch-icon\" sizes=\"180x180\" href=\"/apple-touch-icon.png\"><link rel=\"mask-icon\" href=\"/safari-pinned-tab.svg\" color=\"#131521\"><link rel=\"manifest\" href=\"/site.webmanifest\">" +
        ...
        "<meta name=\"robots\" content=\"noindex,follow\">" +  // ★ 2026-06-28: hub de tickers é founder-gated (público=macro) → noindex sempre; navega p/ quem acessa, fora do índice
        "<script type=\"application/ld+json\">" + ld + "</script>" +
        ...
        "<div class=\"cta-row\"><a class=\"btn\" href=\"/\">" + (en ? "See today&rsquo;s reading" : "Ver a leitura de hoje") + "</a> <a class=\"go\" href=\"" + (en ? "/subscribe" : "/assine") + "\">" + (en ? "See subscriptions →" : "Ver as assinaturas →") + "</a></div>" +
