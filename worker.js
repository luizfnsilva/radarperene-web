...
function _renderDiarioDia(snap, date, origin, lang, nav) {
  ...
  const _pItems = _pItem(en ? "Perene Risk Index" : "Índice de Risco Perene", _pP) + _pItem(en ? "Ânima Index" : "Índice Ânima", _pA) + _pItem(en ? "Ânima · short-term" : "Ânima · curto prazo", _pAc);
