...
function _memoGate(date, hasWeekly) {
  ...
  return '<div id="rp-weekly" class="wsamplebox" style="display:none"></div>' +
    ...
    'if(r.ok){var d=await r.json();if(d&&d.corpo_md){box.innerHTML=\'<div class="memohd">\'+(EN?"Daily report \\u00b7 close of "+DATE:"Relat\\u00f3rio di\\u00e1rio \\u00b7 fechamento de "+DATE)+\'</div><div class="memobody">\'+md(d.corpo_md)+\'</div>\';hideW();return;}}gancho();showW();}catch(e){gancho();showW();}}' +
