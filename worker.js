...
const EN_BODY = (function () {
  const C = {
    ...
    fbadge: "Launch · seats limited to the first 100 founders", fed: "Founder Edition", fprice: '<b style="color:var(--gold)">US$ 149/mo</b>', fh: "The complete instrument.", fp: "Opens: all five Lenses · a library of precedents since 2010 · daily, weekly and monthly reports · analogous cases and their outcomes · the Vértice Experiment · the full cone and its horizons. Locked while your subscription stays active · 7-day refund · cancel in one click.",
