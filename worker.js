...
const EN_FAQ = JSON.stringify({
  "@context": "https://schema.org", "@type": "FAQPage", "inLanguage": "en", "mainEntity": [
    ...
    { "@type": "Question", "name": "What is free, and what does the Founder edition add?", "acceptedAnswer": { "@type": "Answer", "text": "The rule: free shows the readable conclusions; Founder shows the distributions and the statistical structure. On the public radar a visitor sees the regime, 5 lenses, the thesis, intermarket (3 pairs), fiscal, the BR analog summary (median and percent up), 3 Vertice thermometers, 1 divergence of the day and crypto (3 coins + Fear and Greed). The Founder edition (US$ 149/month) opens the statistical structure behind the reading — who leads whom, market breadth as a series, the full divergences and thermometers with their analog studies, crypto on-chain, and per asset the full series of returns/volatility/Sharpe, the quantile cone bands (p10-p90) and fair value/DCF/ERP. In one line: free = understand where we are; Founder = see what historically happened next, with the whole distribution." } },
...
const EN_BODY = (function () {
  ...
  return {
    ...
    "cta3": "Discover Founder →", "cta-deep": "For readers who want to see what underpins the Radar&rsquo;s readings.",
    "fnd-lead": "The mechanisms behind the readings.", "fnd-s": "To see what underpins the readings: the precedents, the historical analogs and the Radar&rsquo;s proprietary observatory.", "fnd-cta": "Discover Founder →",
