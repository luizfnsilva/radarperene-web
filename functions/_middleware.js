// Cloudflare Pages Function — serve EN-static no domínio .com (inclusive p/ crawler SEM JS).
// Ambos domínios servem o MESMO index.html (PT estático). Aqui, só no .com raiz, transformamos
// title/meta/OG/FAQ/lang para EN via HTMLRewriter (stream, sem 2º arquivo a manter).
// DEFENSIVO: qualquer caminho que não seja .com raiz HTML passa intacto; erro → serve o original.
...
const EN_FAQ = JSON.stringify({
  "@context": "https://schema.org", "@type": "FAQPage", "inLanguage": "en", "mainEntity": [
    ...
    { "@type": "Question", "name": "What is the Founder price and what changes later?", "acceptedAnswer": { "@type": "Answer", "text": "US$ 149/month (or US$ 1,490/year, 2 months free), locked for your subscription while it stays active, and it includes all five Lenses and the Vertice Experiment. Later the Lenses will be sold a la carte; Founder secures them all for US$ 149. It is the same product, not a separate premium." } },
