...
function buildSchemas(p, raw, block, lg, title, desc) {
  ...
  const s = [{ "@context": "https://schema.org", "@type": "Organization", "@id": org + "/#org", "name": "Radar Perene", "url": org, "logo": org + "/og.png", "sameAs": ["https://radarperene.com", "https://radarperene.com.br"].filter((u) => u !== org), "founder": { "@id": org + "/#founder" }, "description": en ? "Brazilian regulatory intelligence read as data — regime, intermarket and context." : "Inteligência regulatória brasileira lida como dado — leitura de regime, intermercado e contexto." }, { "@context": "https://schema.org", "@type": "Person", "@id": org + "/#founder", "name": "Luiz F. Nunes da Silva", "url": "https://brazilcomplexity.com/about.html" }];
...
const FOOT_PT = '<a href="/metodologia/">Metodologia</a> · <a href="/como-ler-o-radar/">Como ler</a> · <a href="/conceitos/">Conceitos</a> · <a href="/lentes/">Lentes</a> · <a href="/diario">Diário</a> · <a href="/free/">Versão grátis</a> · <a href="/ativos">Ativos</a> · <a href="/founder/">Founder</a> · <a href="/api/docs/">API</a> · <a href="/widgets/">Widgets</a> · <a href="/sobre">Sobre</a> · <a href="/termos/">Termos</a> · <a href="/privacidade/">Privacidade</a>';
const FOOT_EN = '<a href="/methodology/">Methodology</a> · <a href="/how-to-read-the-radar/">How to read</a> · <a href="/concepts/">Concepts</a> · <a href="/lenses/">Lenses</a> · <a href="/diario">Daily</a> · <a href="/free/">Free</a> · <a href="/ativos">Assets</a> · <a href="/founder/">Founder</a> · <a href="/api/docs/">API</a> · <a href="/widgets/">Widgets</a> · <a href="/about">About</a> · <a href="/terms/">Terms</a> · <a href="/privacy/">Privacy</a>';
